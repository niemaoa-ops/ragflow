...
- entity_type: One of the following types: [{entity_types}]{entity_type_descriptions}
...
- relationship_description: explanation as to why you think the source entity and the target entity are related to each other{relation_type_descriptions}
